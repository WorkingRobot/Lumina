...
public class ExcelBenchmarkClass
{
    private const int Iteration = 100000;

    [Sheet( "Addon" )]
    public class Addon( RawExcelRow row ) : IExcelRow< Addon >
    {
    ...
    [Sheet( "Item" )]
    public class Item( RawExcelRow row ) : IExcelRow< Item >
    {
        public RawExcelRow RawRow => row;
    ...
    public class QuestLinkMarker( RawExcelRow row ) : IExcelRow< QuestLinkMarker >
    {
        public RawExcelRow RawRow => row;
